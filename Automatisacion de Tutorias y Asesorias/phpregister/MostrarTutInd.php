...
<body onload="mueveReloj()">
	<div class="container-fluid" style="background-color: #FFC300;">
		<div class="row">
			...
			<a href="../index.php"><img src="../imgs/logo-uni.png" width="100px" height="100px" class="img-fluid"></a></div>
		<div class="col d-flex align-items-center"><h1>Mostrar Tutoria Individual</h1></div>
		</div>
	</div>
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="../Tutoria_Ind.php">Registrar Tutoria</a>
            <a class="dropdown-item disabled" href="MostrarTutInd.php">Mostrar Tutorias</a>
        </div>
      </li>
...
<div class="container">
	<div class="row">
		...
		<table border="1px" class="table table-responsive table-warning table-hover table-bordered">
			...
			<td><h6>Motivo</h6></td>
			<td><h6>Grupo</h6></td>
			<td><h6>Genero</h6></td><!--Numero de Asesorias sin Validar-->
			...
			<?php
				if($row = mysqli_fetch_array($result1)){
					do {
						echo "<tr><td>".$row["Nombre_Tutor"]."</td><td>".$row["Nombre_Maestro"]."</td><td>".$row["Nombre_Alumno"]."</td><td>".$row["Motivo"]."</td><td>".$row["Grupo"]."</td><td>".$row["Genero"]."</td><td>".$row["Descripcion_Motivo"]."</td><td>".$row["Fecha"]."</td></tr>"; 
