...
<body onload="mueveReloj()">
	<div class="container-fluid" style="background-color: #FFC300;">
		...
		<div class="col d-flex align-items-center"><h1>Mostrar Encuestas de Satisfaccion</h1></div>
		</div>
	</div>
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="../Encuestas_Sat.php">Registrar Encuesta</a>
            <a class="dropdown-item disabled" href="MostrarEncuestas.php">Mostrar Encuestas</a>
        </div>
      </li>
      <!--Final de el Menu despegable-->
...
<div class="container">
	<div class="row">
		...
		<table border="1px" class="table table-responsive table-warning table-hover table-bordered">
			...
			<td><h6>Nombre del Maestro</h6></td>
			<td><h6>Pregunta 1</h6></td>
			<td><h6>Pregunta 2</h6></td>
			<td><h6>Pregunta 3</h6></td>
			<td><h6>Pregunta 4</h6></td>
			...
			<?php
				if($row = mysqli_fetch_array($result1)){
					do {
						echo "<tr><td>".$row["Nombre_Tutor"]."</td><td>".$row["Nombre_Maestro"]."</td><td>".$row["Pregunta_1"]."</td><td>".$row["Pregunta_2"]."</td><td>".$row["Pregunta_3"]."</td><td>".$row["Pregunta_4"]."</td><td>".$row["Nombre_Alumno"]."</td><td>".$row["Promedio"]."</td><td>".$row["Fecha"]."</td></tr>"; 
